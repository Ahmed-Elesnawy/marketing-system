...
<head>
    ...
    <title> @lang('software.adminpanel') | @yield('title')</title>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard') }}/rtl/dist/css/AdminLTE.css">
    ...
    <link rel="stylesheet" href="{{ asset('dashboard') }}/rtl/dist/css/profile.css">
...
<script src="{{ asset('dashboard') }}/custom/jquery.number.min.js"></script>
