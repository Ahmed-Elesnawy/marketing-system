...
class ProvincesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'dashboard.provinces.cols.action')
    ...
    public function html()
    {
        return $this->builder()
                ...
                'buttons' => [
                    ...
                    ['extend' => 'create','className'=>'btn btn-success mb-3','text'=> "<i class='fa fa-plus'></i> ". trans('software.add_province') ],
        ...
        return [
            ...
            [
             ...
             [
                "name" => "shipping_price",
                'data' => 'shipping_price',
                'title' => trans('software.shipping_price'),
            ],
